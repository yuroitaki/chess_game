...
Queen::Queen(string name,string fig,string id,int init_rank,int init_file,ChessPiece*** bod_ptr,ChessBoard* chess_b_ptr):RoyalRider(name,fig,id,init_rank,init_file,bod_ptr,chess_b_ptr){}

Queen::~Queen(){}

bool Queen::check_chess_move(const char* source, const char* desti,int d_rank,int d_file){

  vector<int> rank_move = {1,-1,1,-1,1,0,0,-1};     //basic moves
